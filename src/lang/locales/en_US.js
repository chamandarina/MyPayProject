...
module.exports = {
  ...
  "menu.wizard": "Wizard",
  "menu.transaction": "Make Transaction",
  "menu.transactions": "Transactions",
  "menu.loans": "Loans",
  "menu.loan": "Request Loan",
  
  /* 04.Dashboards */
  "dashboards.total-amount": "Total amount",
  "dashboards.total-amount-rate": "Current amount rate",
  "dashboards.current-month-transactions": "Current month transactions",
  "dashboards.loans": "Loans",
  "dashboards.transactions": "Transactions",
  ...
  "dashboards.send":"Send message",
  "dashboards.support": "Send us a message",
  ...
  /* 07.10.Forms */
  "forms.account": "Account information",
  ...
  "table.react-advanced": "Filter, Length and Jump",
   ...
   "wizard.step-desc-1": "Receiver information",
   "wizard.step-desc-2": "Payment information",
   ...
   "wizard.content-thanks": "Completed!",
   "wizard.next": "Next",
   "wizard.prev": "Back",
   "wizard.registered": "Your transaction has been completed successfully!",
   "wizard.async": "Waiting for loan approval...",
   "wizard.approved": "Approved!",
   "wizard.approval-message": "Your loan has been successfully approved",

   /* 04.28.Transaction */
   "transaction.bank-account-number": "Bank account number",
   "transaction.receiver": "Receiver",
   "transaction.payment-code": "Payment code",
   "transaction.amount": "Amount",
   "transaction.payment-purpose": "Payment purpose",
   ...
   "loan.async": "Waiting for loan approval...",
   "loan.approved": "Approved!",
   "loan.approval-message": "Your loan has been successfully approved",
   "loan.sum": "Amount with interest",
   "loan.month": "Monthly rate",
   "loan.interest": "Interest",
   "loan.request": "Loan request",
   "loan.conditions": "Loan conditions",
   "loan.payment-information": "Payment information"
};
